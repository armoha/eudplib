...
def f_test_compatibility():
    # (Line 17) static var ret = 0;
    ret = EUDVariable(0)
    # (Line 18) const empty = Db(i2b4(0));
    empty = Db(i2b4(0))
    # (Line 19) const cond = Forward();
    cond = Forward()
    # (Line 21) py_exec("from helper import *\n\
    # (Line 30) ");
