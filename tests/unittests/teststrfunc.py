...
def test_strbuffer():
    ...
    Trigger(
        conditions=IsPName(userid, "Armo"), actions=ret.AddNumber(2),
    )
    Trigger(
        conditions=IsPName(userid, "trgk"), actions=ret.AddNumber(16),
    )
    ...
    Trigger(
        conditions=IsPName(userid, name_var), actions=ret.AddNumber(8),
    )
    Trigger(
        conditions=IsPName(userid, EUDVariable(Db("trgk"))), actions=ret.AddNumber(16),
    )
