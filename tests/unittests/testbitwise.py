...
def test_bitwise():
    ...
    test_equality("f_bitnand", f_bitnand(b1100, b1010), ~(0b1100 & 0b1010) & 0xFFFFFFFF)
    test_equality("f_bitnor", f_bitnor(b1100, b1010), ~(0b1100 | 0b1010) & 0xFFFFFFFF)
    test_equality("f_bitnxor", f_bitnxor(b1100, b1010), ~(0b1100 ^ 0b1010) & 0xFFFFFFFF)
