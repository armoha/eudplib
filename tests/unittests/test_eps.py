...
from .test_eps_array import f_test_compare, f_test_queue, f_test_write
...
def test_epscript():
    ...
    test_equality("epScript array test", f_test_array(), 23)
    v = f_test_write()
    test_equality(
    ...
    test_equality("epScript array compare test", f_test_queue(), 31)
