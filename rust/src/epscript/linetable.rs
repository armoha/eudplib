...
pub fn generate_linetable<'a>(
    ...
    let eps_lines: PyResult<Vec<u32>> = positions
        .iter()?
        .map(|i| {
            i.and_then(PyAny::extract::<(u32, u32, i32, i32)>)
                .map(|x| x.0)
        })
        .collect();
    let epspy_lines = eps_lines?;
...
mod tests {
    ...
    fn test_linetables() -> PyResult<()> {
        ...
        Python::with_gil(|py| -> PyResult<()> {
            let positions = py.eval("iter([(0, 1, 0, 0), (2, 2, 0, 21), (2, 2, 0, 21), (2, 2, 0, 21), (2, 2, 0, 21), (3, 3, 0, 118), (3, 3, 0, 118), (3, 3, 0, 118), (3, 3, 0, 118), (3, 3, 0, 118), (3, 3, 0, 118), (3, 3, 0, 118), (3, 3, 0, 118), (3, 3, 0, 118), (3, 3, 0, 118), (3, 3, 0, 118), (3, 3, 0, 118), (3, 3, 0, 118), (3, 3, 0, 118), (4, 4, 0, 129), (4, 4, 0, 129), (4, 4, 0, 129), (4, 4, 0, 129), (4, 4, 0, 129), (4, 4, 0, 129), (4, 4, 0, 129), (4, 4, 0, 129), (4, 4, 0, 129), (4, 4, 0, 129), (4, 4, 0, 129), (4, 4, 0, 129), (4, 4, 0, 129), (4, 4, 0, 129), (4, 4, 0, 129), (4, 4, 0, 129), (4, 4, 0, 129), (4, 4, 0, 129), (4, 4, 0, 129), (4, 4, 0, 129), (4, 4, 0, 129), (4, 4, 0, 129), (4, 4, 0, 129), (4, 4, 0, 129), (4, 4, 0, 129), (4, 4, 0, 129), (4, 4, 0, 129), (4, 4, 0, 129), (4, 4, 0, 129), (4, 4, 0, 129), (4, 4, 0, 129), (4, 4, 0, 129), (6, 6, 6, 11), (6, 6, 6, 11), (6, 6, 12, 23), (6, 6, 12, 23), (6, 6, 25, 26), (6, 6, 6, 27), (6, 6, 6, 27), (6, 6, 6, 27), (6, 6, 6, 27), (6, 6, 6, 27), (6, 6, 6, 27), (6, 6, 6, 27), (6, 6, 28, 29), (6, 6, 6, 30), (6, 6, 6, 30), (6, 6, 6, 30), (6, 6, 6, 30), (6, 6, 6, 30), (6, 6, 0, 3), (6, 6, 0, 3), (6, 6, 0, 3)])", None, None)?;
